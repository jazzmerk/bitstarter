...
console.log("cheery is " + cheery );
for(var ii in checks) {
	  
   var present = cheery(checks[ii]).length > 0;
   rawout[checks[ii]] = present;
}
 var stringify = JSON.stringify(rawout, null, 4); 
...
if(require.main == module) {
	...
	var checkJson = checkHtml(program.check,program.file);
